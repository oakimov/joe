...
/* Path A: almost all of uedit lives in src/uedit.zig; remaining C is
 * delimiter matching only (`utomatch` + helpers).
 */
...
/* Path A: quoting/uctrl live in src/uedit.zig. Remaining: utomatch. */
