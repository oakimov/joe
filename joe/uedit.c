...
/* Path A: `pgamnt`, bol/eol/bof/eof, up/down, tos/bos, uhome,
 * left/right, prev/next word, upedge/unedge, scrup/scrdn,
 * upgup/upgdn, uupslide/udnslide live in src/uedit.zig
 * (JOE uedit.h ABI exports).
 */
