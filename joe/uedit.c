...
/* Path A: most of uedit lives in src/uedit.zig; remaining C is
 * delimiter matching (utomatch) and quoting (uquote/uctrl).
 */

/* Former static helpers; now Zig-exported for remaining C callers. */
...
/* Path A: scrup/scrdn, upgup/upgdn, uupslide/udnslide live in src/uedit.zig. */

/* Move cursor to specified line number */

/* Path A: uline/ucol/ubyte + delete cmds + uinsc live in src/uedit.zig. */

/* Path A: find_indent, utypebw_raw/utypebw/utypew, rtntw, uopen live in src/uedit.zig. */
...
/* Path A: marks/char-search/msg/txt/name/paste live in src/uedit.zig. */
