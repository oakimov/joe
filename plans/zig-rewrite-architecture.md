...
- ✅ Path A UTF-8 body + gutter widen (marks / viewmode tables / visiblews / square / ansi / Feature 2.2 padded rows / `gennum`); still C: non-UTF-8 charmaps + Feature 2.1 simple pipe substitute + rest of `bwgen`/window chrome (scrolling, …) in `joe/bw.c`
