...
- ✅ Path A body + gutter + thin `bwgen` (UTF-8 + byte charmaps / marks / viewmode tables / visiblews / square / ansi / Feature 2.1 residual / Feature 2.2 / `gennum` / paint loops); still C: rest of `lgen_view` region detect + scrolling / window chrome / `bwgenh` in `joe/bw.c`
