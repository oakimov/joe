...
- ✅ Path A UTF-8 body + gutter + thin `bwgen` (marks / viewmode tables / visiblews / square / ansi / Feature 2.2 / `gennum` / paint loops); still C: non-UTF-8 charmaps + Feature 2.1 simple pipe substitute + scrolling / window chrome / `bwgenh` in `joe/bw.c`
