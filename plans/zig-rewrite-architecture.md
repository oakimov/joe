...
- ✅ Screen buffer diff + dirty-cell-only flush — redesign `Screen.flush` cell-diff + EL + within-line ICH/DCH magic + IL/DL scroll magic + combining slots + gated hybrid `scrn` swap landed (default off)
