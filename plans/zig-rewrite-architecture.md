...
- 🚧 Screen buffer diff + dirty-cell-only flush — redesign `Screen.flush` cell-diff + EL landed; within-line “magic” ICH/DCH costing + hybrid `scrn` swap still open
