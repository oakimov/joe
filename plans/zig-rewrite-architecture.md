...
- ✅ Path A UTF-8 body paint widen complete (marks / viewmode tables / visiblews / square / ansi / Feature 2.2 padded rows); still C: non-UTF-8 charmaps + Feature 2.1 simple pipe substitute + rest of `bwgen`/window chrome (`gennum`, scrolling, …) in `joe/bw.c`
