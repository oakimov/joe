...
- 🚧 `edit.zig` / `src/uedit.zig` — Path A live edit commands (motions + scroll/page landed; next: goto-line/col/byte, deletes, type, quote, marks, paste, `utomatch`; then `ublock`/`uformat`)
