//! Auto-generated from joe/charmap.c — builtin encoding tables.
//! Do not edit by hand; regenerate with tools/gen_charmap_data.py if needed.

pub const Alias = struct { alias: [:0]const u8, builtin: [:0]const u8 };

pub const alias_table = [_]Alias{
    .{ .alias = "c", .builtin = "ascii" },
    .{ .alias = "posix", .builtin = "ascii" },
    .{ .alias = "8859-1", .builtin = "iso-8859-1" },
    .{ .alias = "8859-2", .builtin = "iso-8859-2" },
    .{ .alias = "8859-3", .builtin = "iso-8859-3" },
    .{ .alias = "8859-4", .builtin = "iso-8859-4" },
    .{ .alias = "8859-5", .builtin = "iso-8859-5" },
    .{ .alias = "8859-6", .builtin = "iso-8859-6" },
    .{ .alias = "8859-7", .builtin = "iso-8859-7" },
    .{ .alias = "8859-8", .builtin = "iso-8859-8" },
    .{ .alias = "8859-9", .builtin = "iso-8859-9" },
    .{ .alias = "8859-10", .builtin = "iso-8859-10" },
    .{ .alias = "8859-11", .builtin = "iso-8859-11" },
    .{ .alias = "8859-13", .builtin = "iso-8859-13" },
    .{ .alias = "8859-14", .builtin = "iso-8859-14" },
    .{ .alias = "8859-15", .builtin = "iso-8859-15" },
    .{ .alias = "8859-16", .builtin = "iso-8859-16" },
    .{ .alias = "ansi", .builtin = "iso-8859-1" },
    .{ .alias = "latin1", .builtin = "iso-8859-1" },
    .{ .alias = "latin2", .builtin = "iso-8859-2" },
    .{ .alias = "latin3", .builtin = "iso-8859-3" },
    .{ .alias = "latin4", .builtin = "iso-8859-4" },
    .{ .alias = "cyrillic", .builtin = "iso-8859-5" },
    .{ .alias = "arabic", .builtin = "iso-8859-6" },
    .{ .alias = "greek", .builtin = "iso-8859-7" },
    .{ .alias = "hebrew", .builtin = "iso-8859-8" },
    .{ .alias = "latin5", .builtin = "iso-8859-9" },
    .{ .alias = "turkish", .builtin = "iso-8859-9" },
    .{ .alias = "latin6", .builtin = "iso-8859-10" },
    .{ .alias = "nordic", .builtin = "iso-8859-10" },
    .{ .alias = "thai", .builtin = "iso-8859-11" },
    .{ .alias = "latin7", .builtin = "iso-8859-13" },
    .{ .alias = "latin8", .builtin = "iso-8859-14" },
    .{ .alias = "latin9", .builtin = "iso-8859-15" },
    .{ .alias = "latin10", .builtin = "iso-8859-16" },
};

pub const BuiltinCharmap = struct { name: [:0]const u8, to_uni: [256]c_int };

pub const builtin_charmaps = [_]BuiltinCharmap{
    .{
        .name = "ascii",
        .to_uni = .{
