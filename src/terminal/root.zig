...
pub const applySoftCursorAttr = adapter.applySoftCursorAttr;
pub const applySoftCursorCell = adapter.applySoftCursorCell;
pub const softCursorApplied = adapter.softCursorApplied;
pub const isSoftCursorBlankCp = adapter.isSoftCursorBlankCp;
pub const cursorStyleIsInverseOnly = adapter.cursorStyleIsInverseOnly;
