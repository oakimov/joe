#ifndef UMATH_STUBS_H
#undef _FORTIFY_SOURCE
#define _FORTIFY_SOURCE 0
#define UMATH_STUBS_H
...
/* --- umath extras (no system math.h/signal.h — translate-c friendly) --- */
...
int joe_set_signal(int signum, void (*handler)(int));
...
int blklr(BW *bw, double *sumx, double *sumx2, double *sumy, double *sumy2, double *sumxy, int logx, int logy);
char *blkget(BW *bw);
void msgnw(W *w, const char *s);
MACRO *mparse(MACRO *m, char *s, ptrdiff_t *sta, int sec);
int exmacro(MACRO *m, int u, int k);
void rmmacro(MACRO *m);
...
#endif /* UMATH_STUBS_H / PW_STUBS_H */
